...
basepath = 'Z:\Buzsakilabspace\Datasets\McKenzieS\PV5\20160308';
cd(basepath)
...
%%
% sessionNames = sessionsGirardeauG;

for iii = 22:length(sessionNames)
    disp(['*** Calculating cells metrics: ', sessionNames{iii},'. ', num2str(iii),'/', num2str(length(sessionNames)),' sessions'])
    cell_metrics = calc_CellMetrics('sessionName',sessionNames{iii},'excludeManipulations',false,'submitToDatabase',true,'plots', false,'showGUI',true);
