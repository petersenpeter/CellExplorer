...
%
function [idxs, cancelled, mainDlg, raIfRemembered, checkBoxes, allChb]=...
...
if radioOrCheckBox
    ...
    [jsc,bg,checkBoxes, innerPnl]=Radio.Panel2(jsa, dfltIdxs, ...
        itemsPerScrollWindow, ~singleOnly);
...
if radioOrCheckBox 
    ...
    if nOptions>5
        ...
        if isfield(args, 'sortProps') && isfield(args, 'sortProp')
