...
%     Properties    Values
%    -------------------------------------------------------------------------
%     'basepath'    location of data file
...
for i = 1:2:length(varargin),
    ...
    switch(lower(varargin{i})),
        case 'basepath'
            ...
            if ~isa(basepath,'char'),
                error('Incorrect value for property ''basepath'' (type ''help <a href="matlab:help LoadBinary">LoadBinary</a>'' for details).');
            end
        case 'frequency',
...
% If needed, switch to correct file location
prevLocation = pwd;
cd(basepath);
