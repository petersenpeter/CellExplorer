function [ripples] = ce_FindRipples(session,varargin)
...
lfp = double(LoadBinary(fullfile(basepath,[basename, '.lfp']),'nChannels',session.extracellular.nChannels,'channels',p.Results.channel,'precision','int16','frequency',session.extracellular.srLfp));
