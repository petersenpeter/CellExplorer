        ...
        for jjj = 1:size(deepSuperficialfromRipple.ripple_average{jj},2)
            ...
            try
                ...
                try
                    ...
                    try
                        if isfield(deepSuperficialfromRipple,'detectorinfo') &&...
                                deepSuperficialfromRipple.detectorinfo.detectionparms.Channels(1)+1==deepSuperficialfromRipple.ripple_channels{jj}(jjj)
                            plot(deepSuperficialfromRipple.ripple_time_axis,...
                                deepSuperficialfromRipple.ripple_average{jj}(:,jjj)-(jjj-1)*gain,...
                                'k','linewidth',2)
                        end
                    catch
                        if isfield(deepSuperficialfromRipple.detectorinfo,'detectionchannel1')
                            if isfield(deepSuperficialfromRipple,'detectorinfo') &&...
                                    deepSuperficialfromRipple.detectorinfo.detectionchannel1(1)==deepSuperficialfromRipple.ripple_channels{jj}(jjj)
                                plot(deepSuperficialfromRipple.ripple_time_axis,...
                                    deepSuperficialfromRipple.ripple_average{jj}(:,jjj)-(jjj-1)*gain,...
                                    'k','linewidth',2)
                            end
