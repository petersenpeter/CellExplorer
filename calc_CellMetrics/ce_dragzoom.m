...
%         hFig.UserData.leastSignificantBit
%         hFig.UserData.scalingFactor
        set(mRubberBand.obj(1:2), ...
            'XData', [x1 x2 x2 x1], ...
            'YData', [y1 y1 y2 y2]);
        if isfield(hFig.UserData,'scalingFactor')
            set(mRubberBand.obj(3), ...
                'String', [num2str([x2-x1],3),' sec'], ...
                'Position', [x2 y1 0]);
            set(mRubberBand.obj(4), ...
                'String', [num2str([y2-y1]/(hFig.UserData.scalingFactor)*1000,3),' mV'], ...
                'Position', [x1 y2 0]);
        end
